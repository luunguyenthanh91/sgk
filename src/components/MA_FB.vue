  ...
  <div ref="exportRoot">
    <section class="page" v-for="(page, pIdx) in pages" :key="'p-' + pIdx">
      <div class="header-page">
        <span class="title-sgk">Foundation B</span>
        <span class="title-sgk">Mental Arithmetic</span>
        <span class="title-sgk">4 digits</span>
      </div>
    ...
    <section class="page col-5-icon" v-for="(page, pIdx) in pages_2" :key="'p-' + pIdx">
      <div class="header-page">
        <span class="title-sgk">Foundation B</span>
        <span class="title-sgk">Mental Arithmetic</span>
        <span class="title-sgk">5 digits</span>
      </div>
      ...
      <div class="header-page align-end">
        <span class="page-sgk"></span>
        <span class="page-sgk">{{ page.pageIndex + pages.length}}</span>
        <span class="page-sgk"></span>
      </div>
    </section>
    <section class="page col-5-icon" v-for="(page, pIdx) in pages_3" :key="'p-' + pIdx">
      <div class="header-page">
        <span class="title-sgk">Foundation B</span>
        <span class="title-sgk">Mental Arithmetic</span>
        <span class="title-sgk">6 digits</span>
      </div>
      ...
      <div class="header-page align-end">
        <span class="page-sgk"></span>
        <span class="page-sgk">{{ page.pageIndex  + pages.length  + pages_2.length }}</span>
        <span class="page-sgk"></span>
      </div>
    </section>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      pages_3: [], // mỗi phần tử là 1 trang (12 câu), đã tách thành 3 nhóm x 4
    };
  },
  mounted() {
    this.generateAll();
  ...
  methods: {
    ...
    generateAll() {
      const partA = this.makeNumberObjects(135, 1000, 9999);
      const partB = this.makeNumberObjects(96, 10000, 99999);
      const partC = this.makeNumberObjects(234, 100000, 999999);
      // const all = [...partA, ...partB];
      // 12 câu / trang, trong đó mỗi trang tách thành 3 nhóm x 4 câu
      this.pages = this.paginateWithGroups(partA, 9, 3);
      this.pages_2 = this.paginateWithGroups(partB, 6, 2);
      this.pages_3 = this.paginateWithGroups(partC, 6, 2);
    },
