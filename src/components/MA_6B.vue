  ...
  <div ref="exportRoot">
    <section class="page" v-for="(questions, qsIdx) in groups" :key="qsIdx">
      <div class="header-page">
        <span class="title-sgk">Level 6B</span>
...
export default {
  ...
  mounted() {
    ...
    for (let page = 0; page < 67; page++) {
      ...
      // 5 câu decimal unit
      for (let i = 0; i < 10; i++) {
        const q = this.generateThreeTensThreeUnitsWith2Minus();
        items.push(q);
      }
    }
  ...
  methods: {
    generateThreeTensThreeUnitsWith2Minus() {
      ...
      // fallback
      return this.generateThreeTensThreeUnitsWith2Minus();
    },
